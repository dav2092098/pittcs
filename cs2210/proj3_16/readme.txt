...
This project uses results from projects 1 and 2, therefore some discreapncies in the prior projects carry over into this one. For example, the ignoring of letter case is carried over as well as the shift reduce conflicts from project 2.
